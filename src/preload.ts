...
contextBridge.exposeInMainWorld("api", {
    ...
    loadConversationList: (): Promise<Conversation[]> => ipcRenderer.invoke("loadConversationList"),    // 대화 목록 리스트 불러오기
    loadDialogue: (id: number): Promise<Dialogue[]> => ipcRenderer.invoke("loadDialogue", id),          // 대화 상세보기
